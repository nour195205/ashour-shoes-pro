...
class Order(models.Model):
    ...
    payment_status = models.CharField(max_length=20, choices=PAYMENT_STATUS_CHOICES, default='Pending')  # جديد
    transaction_id = models.CharField(max_length=100, null=True, blank=True)  # جديد
